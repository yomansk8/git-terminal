# Contributing to git-terminal

First and foremost, thank you! We appreciate that you want to contribute to git-terminal, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for git-terminal**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for git-terminal:

- star the [project](https://github.com/yomansk8/git-terminal)
- tweet your support for git-terminal
...
- **version**: (required) please note the version of git-terminal are you using
...
The original poster or the maintainers of git-terminal may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/git-terminal
